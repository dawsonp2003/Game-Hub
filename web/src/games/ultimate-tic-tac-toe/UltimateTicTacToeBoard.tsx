...
export default function UltimateTicTacToeBoard({
  ...
  useEffect(() => {
    if (state.macroWinner || activeBoard === null) return
    const el = miniRefs.current[activeBoard]
    if (!el) return
    el.scrollIntoView({ behavior: 'smooth', block: 'center', inline: 'center' })
  }, [activeBoard, state.macroWinner])
  ...
  return (
    <div className="uttt__viewport" ref={viewportRef}>
      <div
          ...
          return (
            ...
            >
              ...
              {Array.from({ length: 9 }, (_, cell) => {
                ...
                const isLast =
                  lastMove?.board === board && lastMove?.cell === cell
